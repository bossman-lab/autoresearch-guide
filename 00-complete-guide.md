...
| 来源 | 作者/机构 | 年份 | 本文引用位置 |
|------|----------|:----:|:----------:|
| **METR Paradox** — RCT 对照实验：AI 感知提速 vs 实际完成率 | METR 研究团队 | 2026 | §一 METR Paradox |
| **Faros Paradox** — AI 代码导致 PR 审核时间 +91% | Faros Engineering Report | 2026 | §一 Faros Paradox / §九 风险分级审核 |
| **DORA Mirror** — AI 放大现有团队质量差距 | Djimit（N=906 调查） | 2026 | §一 DORA Mirror |
| **DORA 2025 研究报告** — AI 辅助编码对交付速度的影响 | DORA / CodeRabbit | 2025-2026 | §十三 监控指标 |
| **95% 企业未从 AI 投资获得有意义的回报** | MIT 调查 | 2025 | §四 AI Context Debt |

### AI Context Debt 与上下文工程

| 来源 | 作者/机构 | 年份 | 本文引用位置 |
|------|----------|:----:|:----------:|
| **AI Context Debt** 概念原创 | Abbas Raza | 2026.04 | §四 |
| **InfoQ 深度解析：AI 上下文负债** | InfoQ | 2026 | §四 |
| **Context Engineering 最佳实践指南** | Laurent Py / Packmind | 2026 | §四 Context Engineering |
| **ACE 研究：增量上下文更新减少 86% 漂移** | Stanford / SambaNova | 2025.10 | §四 Context Engineering |
| **GitClear 报告：AI 时代代码重复率 4 倍增长** | GitClear | 2024 | §四 |
...
| 来源 | 作者/机构 | 年份 | 本文引用位置 |
|------|----------|:----:|:----------:|
| **AutoResearch** 方法论与开源实现 | Andrej Karpathy | 2026 | §一 / §六 |
| **通用化 AutoResearch 到非 ML 任务** | Udit Goenka（Claude Code skill） | 2026 | §六 |
| **5 种 AI 隐藏技术债** | Ajay Mudettula / DEV | 2026 | §九 风险分级审核 |

### 方法论与工具

| 来源 | 作者/机构 | 年份 | 本文引用位置 |
|------|----------|:----:|:----------:|
| **Specification-Driven Development**（spec-kit, OpenSpec） | GitHub / 社区 | 2026 | §四 SDD |
| **Claude Code Agent 模式与 /goal 系统** | Anthropic | 2025-2026 | §六 / §十二 |
| **Hermes Agent Subagent-Driven-Development** | Hermes Agent 社区 | 2026 | §三 / §九 |
